...
void cleanFilter(void) {
  printf("Cleaning filter...\n");
  // Tambahkan kode di sini untuk mengontrol motor yang membersihkan filter
  // Contohnya, Anda dapat menggunakan fungsi 'activateMotor' untuk mengatur kecepatan motor
  activateMotor(1500); // Atur kecepatan motor ke 1500 RPM
  sleep(5 * 60); // Tunggu selama 5 menit
  activateMotor(0); // Menghentikan motor
  printf("Filter cleaning complete.\n");
}
